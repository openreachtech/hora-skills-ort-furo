...
at the end and let the developer choose (the `hof-uiux-forge` generator skill, if installed,
...
If absent, **create `uiux-context.md` so the audit can see the project** — use the `hof-uiux-context` skill
