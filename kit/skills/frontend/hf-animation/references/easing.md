...
If the standard curves ever feel too weak for a specific interaction, add a stronger named token to `variables.css` rather than inlining a `cubic-bezier` in the component — see [[hf-css]] design tokens.
