...
Never create refs/computed/reactive inside the context class, and never call a composable inside the context — do both in `setup`. See [[hof-furo-context-patterns]].
