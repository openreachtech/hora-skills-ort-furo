...
The page root is always `<div class="unit-page">`. Reusable sub-blocks get their own `unit-` name. Selectors use child combinators and design tokens (`.unit-page > .membership .heading`, `var(--color-...)`). Full rules: [[hof-css]].
