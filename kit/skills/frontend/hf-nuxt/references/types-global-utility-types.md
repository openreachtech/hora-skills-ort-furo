...
`RequiredExcept` is the standard way to type a context/module `FactoryParams` that has DI-defaulted keys (see [[hf-furo-context-patterns]], [[hc-jsdoc]]).

## GraphQL schema namespace (`graphql-schema.d.ts`)

Generated entity/input/result types under `declare global { namespace schema.graphql { ... } }`, referenced everywhere as `schema.graphql.<Type>` without import. Full details in [[hf-graphql]].
